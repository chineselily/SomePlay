...
half4 _AfsTerrainTreeLightColor0;
fixed3 _AfsTerrainTreeLightDir0;
...
half3 AFSTrilight (float3 normal) {
	return (_AfsSkyColor * normal.y + _AfsGroundColor * saturate(normal.y*(-1)) + _AfsEquatorColor * (1-abs(normal.y)) ) * 0.5 ;
}
